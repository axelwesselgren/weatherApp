...
/**
 * {@code WeatherDay} is an enum that contains the
 ...
 */
public enum WeatherDay implements WeatherType {
    FILE_1(1, "day/1.png"),
    FILE_2(2, "day/2.png"),
    FILE_3(3, "day/3.png"),
    FILE_4(4, "day/4.png"),
    ...
    /**
     * Path to the image located in /resources/weather/day.
     */
    public final String fileName;

    /**
     * Constructor for the {@code WeatherDay}.
     * 
     * @param id The identifier of the weather.
     * @param fileName The path to the image.
     */
    private WeatherDay(int id, String fileName) {
        this.id = id;
        this.fileName = fileName;
    }

    /**
     * Get the {@code WeatherDay} constant based on the id.
     * 
     * @param id The identifier of the weather.
     * @return The WeatherDay corresponding to the id.
     */
    public static WeatherDay getWeather(int id) {
        for (WeatherDay w : WeatherDay.values()) {
            if (w.id == id) return w;
        }
        return null;
    }
